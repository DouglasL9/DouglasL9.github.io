...
function inicio(){
  ...
  document.getElementById("cremacao").hidden=true
  document.getElementById("sepultamento").hidden=true
  document.getElementById("planos").hidden=true
...
function cremacao(){
  ...
  document.getElementById("cremacao").hidden=false
  document.getElementById("sepultamento").hidden=true
  document.getElementById("planos").hidden=true
  document.getElementById("contato").hidden=true
}
...
function sepultamento(){
  ...
  document.getElementById("galeria").hidden=true
  document.getElementById("cremacao").hidden=true
  document.getElementById("sepultamento").hidden=false
  document.getElementById("planos").hidden=true
  document.getElementById("contato").hidden=true
}
...
function showCeara(){
  document.getElementById("ceara-mapa").hidden=false
  document.getElementById("pb-mapa").hidden=true
  document.getElementById("df-mapa").hidden=true
}

function showPernanbuco(){
  document.getElementById("ceara-mapa").hidden=true
  document.getElementById("pb-mapa").hidden=false
  document.getElementById("df-mapa").hidden=true
}

function showBrasilia(){
  document.getElementById("ceara-mapa").hidden=true
  document.getElementById("pb-mapa").hidden=true
  document.getElementById("df-mapa").hidden=false
}

//transição img

document.addEventListener("DOMContentLoaded", function() {
  var img = document.querySelector("#img-brasil");
